...
/*
 * The structure below gathers variables that may be used by the simulated API calls to mock behavior
 * of a flash device; the variables may be used however it is desired, because it is
 * up to the mocked functions and checks afterwards to relate these variables to results
 */
static struct {
